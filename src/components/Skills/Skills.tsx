...
const Skills = () => {
  return (
    <section className="mx-auto my-32 h-fit lg:w-[1100px] xl:w-[1500px]">
      ...
      <div className="z-[2] mx-auto grid w-[90%] grid-cols-1 gap-10 lg:m-0 lg:w-full lg:grid-cols-3 xl:grid-cols-3 xl:gap-[80px]">
        {skillList.map((skill, index) => (
          <div key={index} className="lg:m-0">
            ...
            <ul className="flex flex-col gap-2 lg:mt-4">
              {skill.skills.map((perSkill, skillIndex) => (
                <li
                  key={skillIndex}
